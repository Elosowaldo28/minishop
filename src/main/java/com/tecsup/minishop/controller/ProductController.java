...
import com.tecsup.minishop.service.ProductService; import org.springframework.http.HttpStatus;
...
@RestController @RequestMapping("/api/products") public class ProductController {
    ...
    public ResponseEntity<Product> create(@RequestBody Product product) { return ResponseEntity.status(HttpStatus.CREATED)
