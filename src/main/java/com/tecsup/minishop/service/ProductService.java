...
import com.tecsup.minishop.repository.ProductRepository; import org.springframework.stereotype.Service;
...
public class ProductService {
    ...
    public Product save(Product product) { if (product.getPrice() <= 0) {
